...
<body>
				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button"
						data-toggle="dropdown"> <span class="user-icon"> <i
							class="icon-copy bi bi-person p-3"></i>
					</span> <span class="user-name"><%=Supplier.getName()%></span>
					</a>
					<div
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li><a href="supplierDashboard.jsp"
						class="dropdown-toggle no-arrow"> <span class="micon"><i
								class="icon-copy bi bi-card-checklist"></i></span><span class="mtext">View
								Requirements</span>
					</a></li>
					<li><a href="supplierComplaint.jsp"
						class="dropdown-toggle no-arrow"> <span class="micon"><i
								class="icon-copy bi bi-eye"></i></span><span class="mtext">View
								Complaints</span>
					</a></li>
					<li><a href="supplierDelivered.jsp"
						class="dropdown-toggle no-arrow"> <span class="micon"><i
								class="icon-copy bi bi-truck"></i></span><span class="mtext">Delivered
								Order</span>
					</a></li>
				</ul>
			</div>
	...
	<%
		String sql = "SELECT r.*, s.name AS school_name, s.address, s.contact, mi.name AS mealitem_name FROM requirement r JOIN school s ON r.school_id = s.school_id JOIN mealitem mi ON r.item_id = mi.item_id WHERE r.status = ?";
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						...
						: (rs1.getString("status").equals("Delivered") ? "badge-success" : "badge-danger")%>">
							...
							<td>
								<a href="./markDelivered.jsp?reqid=<%=rs1.getInt("r.req_id")%>">
