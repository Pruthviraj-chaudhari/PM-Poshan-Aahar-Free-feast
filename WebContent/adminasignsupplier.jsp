...
<div class="main-container">
            <div class="xs-pd-20-10 pd-ltr-20">
                        ...
                        <% while(rs1.next()) { %>
                            <tr>
                                ...
                                <td>
                                 ...
                                 <a href="./updateRequirement.jsp?sup_id=<%= rs1.getInt("sup_id") %>&req_id=<%= request.getParameter("req_id") %>">
    								<button class="btn btn-outline-success">Select Supplier</button>
								</a>
                ...
                <div class="footer-wrap pd-20 mt-30 mb-30 card-box">
                    ...
                    <a href="https://github.com/dropways" style="text-decoration: none;" class="text-secondary" target="_blank">Read More...</a>
                </div>
            </div>
        </div>
