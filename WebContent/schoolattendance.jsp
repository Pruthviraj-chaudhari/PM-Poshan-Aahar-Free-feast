...
<body>
	...
	<%
		String sql = "SELECT * FROM student JOIN attendance ON student.stud_id = attendance.stud_id AND student.school_id = attendance.school_id WHERE student.school_id = ?";

		Connection conn = DbConnection.connect();
		PreparedStatement st1 = conn.prepareStatement(sql);
		st1.setInt(1, School.getId());
		ResultSet rs1 = st1.executeQuery();

		System.out.println("Attendance fetched.");
	%>
	<% 
	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0"><%= currentMonth + " " + currentYear%></h2>
			</div>

			<div class="card-box pb-10">
				<div class="h5 pd-20 mb-0">Attendance List</div>
				<table class="data-table table nowrap">
					<thead>
						<tr>
							<th style="text-align: center;">Student ID</th>
							<th class="table-plus" style="text-align: center;">Student
								Name</th>
					...
					<tbody>
						...
						<tr>
							<td style="text-align: center;"><%=rs1.getInt("stud_id")%></td>
							<td class="table-plus" style="text-align: center;"><%=rs1.getString("name")%></td>
							<td style="text-align: center;"><%=rs1.getString("month")%></td>
							<td style="text-align: center;"><%=rs1.getInt("present_days")%>
							<td>
						</tr>
			...
			<div class="pd-20 card-box mb-30 mt-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue h4">Add New Month Attendance</h4>
					</div>
				</div>

				<form action="InsertAttendance" method="post">
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">Reg.
							Student ID</label>
					...
					<div class="form-group row">
						...
						<label class="col-sm-12 col-md-2 col-form-label">Present
							Days</label>
						<div class="col-sm-12 col-md-3">
							<input class="form-control" type="text" placeholder="22"
								name="presentDays" />
						</div>
					</div>
					<div class="form-group row">
