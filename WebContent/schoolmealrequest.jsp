	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Request Meal Items</h2>
			</div>
	...
	%>
			...
			<div class="card-box pb-10">
				<div class="h5 pd-20 mb-0 text-success text-center">
					Government Approved Meal of
					<%=nextMonth + " " + currentYear%></div>
				<table class="data-table table nowrap text-center">
					<thead>
						<tr>
							<th>ID</th>
							<th>Name</th>
							<th>Quantity Assigned / Day</th>
							<th>Units</th>
						</tr>
					</thead>
					<tbody>
			...
			<form action="calculatemeal.jsp">
				<div class="form-group row">
					<div class="col-sm-12 mt-30">
						<button type="submit" class="btn btn-success float-right">
							Calculate Upcoming Month Meal <i class="icon-copy bi bi-plus"></i>
						</button>
						<p class="text-danger mt-2">(*Note: Please update attendance of
							<%= currentMonth %> before requesting for <%= nextMonth %>)</p>
					</div>
				</div>
			</form>
