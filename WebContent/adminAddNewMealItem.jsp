	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Meal Items</h2>
			</div>
			...
			<div class="pd-20 card-box mb-30 mt-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue h4">Add New Meal Item</h4>
					</div>
				</div>

				<form action="AdminAddNewMeal" method="post">
					<div class="form-group row">
						<label class="col-sm-12 col-md-3 col-form-label">Item Name</label>
						<div class="col-sm-12 col-md-9">
							<input class="form-control" type="text" placeholder="Fruits"
								name="itemName" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-12 col-md-3 col-form-label">Quantity
							/ Day</label>
						<div class="col-sm-12 col-md-9">
					...
					<div class="form-group row">
						<label class="col-sm-12 col-md-3 col-form-label">Measure
							Units</label>
