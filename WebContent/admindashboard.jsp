			...
			<div class="user-notification">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll"></div>
					</div>
				</div>
			</div>
	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="card-box pb-10">
				<div class="h5 pd-20 mb-0">Schools List</div>
				<table class="data-table table nowrap">
					<thead>
						<tr>
							<th>School ID</th>
							<th class="table-plus">School Name</th>
							<th>Address</th>
					...
					<tbody>
						...
						<tr>
							...
							<td><%=rs1.getString("school_username")%></td>
							<td><%=rs1.getString("school_password")%></td>
							<td>
								<div class="table-actions">
									<a href="#" data-color="#265ed7"> <i
										class="icon-copy dw dw-edit2"></i></a> <a
										href="./deleteschool.jsp?id=<%=rs1.getInt("school_id")%>"
			...
			<div class="pd-20 card-box mb-30 mt-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue h4">Add New School</h4>
					</div>
				</div>

				<form action="AdminSchool" method="post">
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">School
							Name</label>
						<div class="col-sm-12 col-md-10">
							<input class="form-control" type="text" placeholder="ABC School"
								name="schoolName" />
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input class="form-control" type="text" placeholder="345271536"
								name="schoolContact" />
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							<input class="form-control" type="text"
								placeholder="school_username" name="schoolUsername" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">School
						...
						<div class="col-sm-12 col-md-10">
							<input class="form-control" type="password"
								placeholder="school_password" name="schoolPassword" />
						</div>
					</div>
