...
<div class="alert-container">
        ...
        %>
        <div class="alert alert-success">Complaint Posted Successfully!</div>
        <%
            } else if (successParam != null && successParam.equals("false")) {
        %>
        <div class="alert alert-danger">Complaint Posting Failed!</div>
        <%
            }
        %>
    </div>
	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Add Complaint</h2>
			</div>

			<div class="pd-20 card-box mb-30 mt-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue h4">Complaint Form</h4>
					</div>
				</div>

				<form action="InsertComplaint" method="POST">
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 col-form-label">School ID</label>
						<div class="col-sm-12 col-md-10">
							<input class="form-control" type="text" name="schoolId"
								value="<%=School.getId()%>" disabled />
						</div>
					</div>
					<div class="form-group row">
