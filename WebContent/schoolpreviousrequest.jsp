...
<body>
	...
	<%
		String sql = "SELECT r.req_id AS req_id, mi.name AS item_name, r.quantity AS approved_quantity, r.status, r.month FROM requirement r JOIN mealitem mi ON r.item_id = mi.item_id WHERE r.school_id = ?";
		Connection conn = DbConnection.connect();
		PreparedStatement st1 = conn.prepareStatement(sql);
		st1.setInt(1, School.getId());
		ResultSet rs1 = st1.executeQuery();

		System.out.println("School Previous Requirements");
	%>
	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">School Meal</h2>
			</div>

			<div class="card-box pb-10">
				<div class="h5 pd-20 mb-0 text-secondary">All Requested Meals
				</div>
				<table class="data-table table nowrap text-center">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=rs1.getInt("approved_quantity")%></td>
							<th><%=rs1.getString("month")%></th>
							<td><span
